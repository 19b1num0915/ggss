...
export const _ecommerceSalesOverview = [...Array(5)].map((_, index) => ({
  label: [
    'Баталгаажсан худалдан авалтын тоо',
    'Цуцалсан худалдан авалтын тоо',
    'Хүлээгдэж байгаа худалдан авалтын тоо',
    'Төлж дууссан худалдан авалтын тоо',
...
export const _ageCategory = [...Array(9)].map((_, index) => ({
  label: [
    '18-25 нас',
    '25-30 нас',
    '30-35 нас',
